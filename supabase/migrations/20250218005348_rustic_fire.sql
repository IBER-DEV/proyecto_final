/*
  # Create secure user email lookup function and view

  1. Changes
    - Create a secure function to access user emails
    - Create a view that uses the secure function
    - Grant necessary permissions

  2. Security
    - Function checks for authenticated users
    - View only exposes necessary fields
    - Restricted access through permissions
*/
